...
[LINK]: https://www.codewars.com/kata/row-weights/train/javascript
*/
function rowWeights(array){
  var countWeight1 = 0
  var countWeight2 = 0

  //mencari nilai countWeight1
  for(var a = 0; a < array.length; a+=2){
    countWeight1 += array[a]
  }

  //mencari nilai countWeight2
  for(var a = 1; a < array.length; a+=2){
    countWeight2 += array[a]
  }

  return [countWeight1, countWeight2]
}
